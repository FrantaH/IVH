...
PROJECT = project.xml
OUTPUTPREFIX = lightsout
FPGACHIP = xc3s50
FPGASPEEDGRADE = 4
FPGAPACKAGE = pq208

all: dependencycheck build/lightsout_f1xx.hex build/lightsout_f2xx.hex build/lightsout.bin

#MCU part
#=====================================================================
HEXFILE_F1XX = build/lightsout_f1xx.hex
HEXFILE_F2XX = build/lightsout_f2xx.hex
...
HDLFILES += fpga/lightsout_top.vhd
HDLFILES += fpga/cell.vhd
HDLFILES += fpga/bcd.vhd
HDLFILES += fpga/lightsout_pack.vhd

build/lightsout.bin: build/fpga/lightsout.par.ncd build/fpga/lightsout.pcf
